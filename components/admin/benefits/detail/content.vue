...
export default {
  ...
  methods: {
    ...
    async setFillData(oItem) {
      ...
      this.iStatus = this.getStatusBenefits(oItem.BenefitStatusRecords.eStatus);
      ...
      this.sCommensalQuantities = `Para ${oItem.CommensalQuantities.map((e) => {
        return e.iQuantity;
      }).join(", ")}`;
      // #endregion Cantidad de personas
      ...
      this.oItem = {
        ...
        sCommentRecord: this.getInfofinalizedOrCancelled(oItem).sCommentRecord,
